...
export default function MapCard({id, title, imgSrc, origin, isSelected, onSelect}) {
  ...
  return (
    <div className={`${styles.mapCard} ${isSelected ? styles.selected : ""}`}>
      ...
      <img src={imgSrc} alt="" className={styles.cardImg}/>
      {
        ...
        :
        <Link to={`/leaderboard/map/${id}`} className={styles.playBtn} onClick={handleClick}>Leaderboard</Link>
      }
